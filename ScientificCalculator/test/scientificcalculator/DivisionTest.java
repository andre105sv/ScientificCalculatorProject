...
public class DivisionTest{
    ...
    public void testExecute() throws DivisionByZeroException, NotDefinedArgumentException{
        ...
        ArithmeticalOperations division = factory.getArithmeticalOperations("DIVISION", a, b, DECIMAL_NUMBERS);
        ...
        ArithmeticalOperations division1 = factory.getArithmeticalOperations("DIVISION", a1, b1, DECIMAL_NUMBERS);
        ComplexNumber result1[] = division1.execute();
        ComplexNumber a2 = new ComplexNumber(-32, +7.12);
        ComplexNumber b2 = new ComplexNumber(0, 0);
        ArithmeticalOperations division2 = factory.getArithmeticalOperations("DIVISION", a2, b2, DECIMAL_NUMBERS);
