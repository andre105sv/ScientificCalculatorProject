...
public class Modulo implements ArithmeticalOperations{
    ...
    /**
    * Costruisce un oggetto di tipo Modulo a partire da un numero 
    ...
    */
    public Modulo(ComplexNumber operand, double decimals) {
        this.operand = operand;
        this.decimals = decimals;
    }
    /**
    * Restituisce il modulo di un numero complesso. 
    * @return   un array di ComplexNumber contenente il modulo del numero complesso.
    */
    @Override
